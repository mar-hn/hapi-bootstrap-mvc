...
[
  ...
  { method: 'POST', path: '/users/add', options: { handler: UsersCtrl.addUser } },
  { method: 'POST', path: '/users/edit', options: { handler: UsersCtrl.editUser } },
  { method: 'POST', path: '/users/delete', options: { handler: UsersCtrl.deleteUser } }
];